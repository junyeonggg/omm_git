...
async function checkNickname() {
    ...
    try {
        const response = await $.ajax({
            type: "get",
            dataType: "text",
            url: "https://403b-1-245-252-171.ngrok-free.app/checkNickname",
            data: { data: nickname }
        });
...
update_email()
    ...
    try {
        const response = await $.ajax({
            type: "get",
            dataType: "text",
            url: "https://403b-1-245-252-171.ngrok-free.app/checkEmail",
            data: { data: email }
        });
        if (response.trim() === "true") {
...
async function checkTel() {
    ...
    try {
        const response = await $.ajax({
            type: "get",
            dataType: "text",
            url: "https://403b-1-245-252-171.ngrok-free.app/checkTel",
            data: { data: fullTel }
        });
...
function socialsubmitForm(){
   ...
   if(!isTelChecked) {
    ...
    $.ajax({
        type : "post",
        url : "https://403b-1-245-252-171.ngrok-free.app/socialjoin",
        contentType: false,
        processData: false,
        data: formJoin,
        success : data=>{
            ...
            if(data=='true'){
                $.ajax({
                    type : "post",
                    url : "https://403b-1-245-252-171.ngrok-free.app/login",
                    data: {'username':user_id,'password':user_id},
                    success : data=>{
                            window.location.replace("https://403b-1-245-252-171.ngrok-free.app")
                            }
                })
            }
        }
